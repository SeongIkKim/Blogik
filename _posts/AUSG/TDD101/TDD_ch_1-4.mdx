---
title: 테스트 주도 개발 ch 1-4
date: 2020-09-25
tags: [AUSG, TDD]
excerpt: Test-Driven Development:By Example ch 1-4
---

본 글은 켄트 백의 [<테스트 주도 개발>](http://www.yes24.com/Product/Goods/12246033)을 읽고 개인적으로 정리한 내용입니다. 내용에 오류가 있을 시 지적해주시면 감사하겠습니다.
...
어찌됐든 결과가 앞으로 이렇게 나와야 하니, <u>__껍데기만 작성__</u>해두자. 그럼 테스트를 통과했다!
...
우리의 목적은 __작동하는 깔끔한 코드__를 얻는것이다.
...
> 1. 가짜로 구현하기 : 상수를 반환하게 만들고 진짜 코드를 얻을 때까지 단계적으로 상수를 변수로 바꾸어 나간다.
